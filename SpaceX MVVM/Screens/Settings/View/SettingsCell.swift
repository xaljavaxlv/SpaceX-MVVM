...
final class SettingsCell: UITableViewCell {
    ...
    private func createLeftLabel() {
        ...
        leftLabel.centerYAnchor.constraint(equalTo: segmentControl.centerYAnchor).isActive = true
    ...
    private func createSegmentControl() {
        ...
        segmentControl.rightAnchor.constraint(equalTo: contentView.rightAnchor, constant: -globalMargins).isActive = true
